    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans pb-12">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-gray-900 hidden sm:block">Tra Cứu Hồ Sơ DVC</h1>
            <h1 className="text-xl font-bold text-gray-900 sm:hidden">DVC</h1>
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex flex-col items-end mr-4">
              ...
              {unauthorized ? (
                ...
                <span className="text-xs font-bold text-orange-500">Lỗi dữ liệu</span>
              ) : loading ? (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {networkError && !useMock && (
          <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded-md shadow-sm">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-orange-800 font-bold">Lỗi Kết Nối</h3>
        ...
        {errorMsg && !loading && (
          <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-md shadow-sm">
            <div className="flex items-start">
              <ICONS.AlertCircle className="h-5 w-5 text-red-500 mt-0.5 mr-3" />
              <div>
        ...
        <div className="bg-white rounded-xl shadow p-6 border border-blue-100 bg-gradient-to-r from-blue-50 to-white">
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-lg border border-gray-100 p-4 flex items-center gap-3">
              ...
              <div>
                <div className="text-xs text-gray-500">API Đạt</div>
                <div className="text-lg font-bold text-gray-900">{loading ? '...' : totalDat.toLocaleString('vi-VN')}</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-100 p-4 flex items-center gap-3">
              ...
              <div>
                <div className="text-xs text-gray-500">API Sáu</div>
                <div className="text-lg font-bold text-gray-900">{loading ? '...' : totalSau.toLocaleString('vi-VN')}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Loading */}
        {loading && (
          <div className="mt-2 flex items-center space-x-3 text-sm text-gray-600 animate-pulse">
            ...
            <div className="overflow-y-auto space-y-6 px-1 pb-2">
              <div className="space-y-4">
                ...
                <div className="text-xs text-gray-500 flex items-start gap-2">
                  ...
                  <span>
                    API URL cố định: <strong className="font-mono text-gray-700">{DEFAULT_API_BASE_URL || '(same origin)'}</strong>
                  </span>
                </div>
